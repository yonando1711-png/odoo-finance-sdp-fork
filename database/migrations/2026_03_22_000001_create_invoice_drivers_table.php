...
return new class extends Migration
{
    ...
    {
        Schema::create('invoice_drivers', function (Blueprint $table) {
            $table->id();
            $table->string('odoo_id')->nullable()->index();
            $table->string('name')->unique();           // INVDV/2025/00169
            ...
            $table->string('journal_name')->default('Invoice Driver');
        ...
        Schema::create('invoice_driver_lines', function (Blueprint $table) {
            $table->id();
            $table->foreignId('invoice_driver_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('invoice_driver_lines');
        Schema::dropIfExists('invoice_drivers');
    }
};
